...
# Sequence file
sequence_file = "C:/Users/caste/OneDrive/Desktop/Assignment 3/dataset/MOT17-13-DPM-DETR07.txt"
...
# Images path
images_path = f"C:/Users/caste/OneDrive/Desktop/Assignment 3/dataset/train/MOT17-13-DPM/img1"

# soglia matching = 0.4, soglia re_id = 0.4
detections_to_save_0404 = process_image_folder_preloaded(final_detections, images_path, frame_size=(1920, 1080), detection_interval=1, frame_limit_flag=False, limit=10, threshold_det_track=0.5, threshold_reid=0.5)

# Save path
save_path = f"C:/Users/caste/Unipa - IntelliCrafters/Visione artificiale/Assignments/Assignment 3/outputs/MOT17-13-DPM-07-05-05.txt"
...
output_video_path = f"C:/Users/caste/Unipa - IntelliCrafters/Visione artificiale/Assignments/Assignment 3/outputs/NEWMOT17-13-DPM-07-05-05.mp4"
